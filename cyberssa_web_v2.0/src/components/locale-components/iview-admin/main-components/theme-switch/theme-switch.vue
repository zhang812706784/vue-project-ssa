...
export default {
    ...
    methods: {
        setTheme (themeFile) {
            ...
            if (config.env.indexOf('dev') > -1) {
                stylePath = './src/components/locale-components/iview-admin/main-components/theme-switch/theme/';
            } else {
                stylePath = 'dist/';
            }
            if (mainTheme !== 'b') {
    ...
    created () {
        let path = '';
        if (config.env.indexOf('dev') > -1) {
            path = './src/components/locale-components/iview-admin/main-components/theme-switch/theme/';
        } else {
            path = 'dist/';
        }
