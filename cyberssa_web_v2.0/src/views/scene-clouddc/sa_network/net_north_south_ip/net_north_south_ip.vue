<!--Created by zmj on 2018/8/16-->
<template>
    <Tabs value="IP流量统计分析">
        <TabPane label="IP流量统计分析" name="IP流量统计分析">
        ...
        <TabPane label="IP流量日志列表" name="IP流量日志列表">
            <tp-table :all_params="ipflowlist" ></tp-table>
        </TabPane>
...
<script type="es6">
    ...
    export default {
        ...
        created(){
            this.realTimeRate={
                flow:"north_south",
                    ...
                    //一级钻取字段和二级钻取字段
                    FirstDrillingType:'UserIp',
                    SecondDrillingType:"AppName",
                    ShowFiled:'up',
                    select_data:[{val:'up',text:"上行"},{val:'down',text:"下行"},{val:'double',text:"双向"}],
        ...
        methods: {
            ...
            bytesFormat (bytes) {
                console.log(11111111111111111111111,bytes);
