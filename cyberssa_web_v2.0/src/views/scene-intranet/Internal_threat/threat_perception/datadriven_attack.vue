<template>
    <div>
        ...
        <Row style="height: 200px;font-size: 30px;text-align: center">
            ...
            <p style="font-size: 20px;margin-top: 50px;">存在数据驱动攻击行为的主机<span class="num">{{Srcnum}}</span>个，其中服务器<span class="num">{{Servernum}}</span>个，遭受数据驱动攻击行为的服务器<span class="num">{{Dstnum}}</span>个</p>
        </Row>
        <Row>
...
<script>
    ...
    export default {
            ...
            return{
                ...
                lineparams:{
                    ...
                    data: {
                        ...
                        type: 'nsec',
                        CombQuery:{
                            'logtype':['LOG_APPSEC_FILECONTROL','LOG_APPSEC_AV','LOG_APPSEC_DATAFILTER'],
                            "threatType":["内部"]
                        },
                        begTime: null,
                        endTime: null
                ...
                barparams:{
                    ...
                    data: {
                        ...
                        // 'EventType':['木马攻击','间谍软件攻击','恶意攻击','蠕虫攻击','文件识别']
                        aggField:'SrcIP',
                        begTime: null,
                        endTime: null,
                        size: 5
        ...
        methods:{
            ...
            changeDate(params){
                let bTime = new Date(params[0]).getTime();
                let eTime = new Date(params[1]).getTime();
