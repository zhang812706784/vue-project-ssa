<template>
    <div>
        ...
        <Row style="height: 200px;font-size: 30px;text-align: center">
            ...
            <p style="font-size: 20px;margin-top: 50px;">存在拒绝服务攻击行为的主机<span class="num">{{Srcnum}}</span>个，其中服务器<span class="num">{{Servernum}}</span>个，遭受数据驱动攻击行为的服务器<span class="num">{{Dstnum}}</span>个</p>
        </Row>
        <Row>
