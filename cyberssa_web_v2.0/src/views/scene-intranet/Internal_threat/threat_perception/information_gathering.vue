<template>
    <div>
        ...
        <Row style="height: 200px;font-size: 30px;text-align: center">
            ...
            <p style="font-size: 20px;margin-top: 50px;">存在信息收集攻击攻击行为的主机<span class="num">{{Srcnum}}</span>个，其中服务器<span class="num">{{Servernum}}</span>个，遭受数据驱动攻击行为的服务器<span class="num">{{Dstnum}}</span>个</p>
        </Row>
        <Row>
            ...
            return{
                ...
                lineparams:{
                    ...
                    data: {
                        ...
                        type: 'nsec',
                        CombQuery:{
                            'logtype':['LOG_FW_FILTER','LOG_LOCALPORTSCAN'],
                            "threatType":["内部"]
                        },
                       //'EventType':['finger服务攻击','安全扫描','目录扫描攻击','sql注入攻击','爬虫攻击','web扫描']
                        begTime: null,
                        endTime: null
                    }
                },
                barparams:{
                    ...
                    data: {
                        ...
                        CombQuery:{'logtype':['LOG_FW_FILTER','LOG_LOCALPORTSCAN']},
                    // 'EventType':['finger服务攻击','安全扫描','目录扫描攻击','sql注入攻击','爬虫攻击','web扫描']
                        aggField:'SrcIP',
                        begTime: null,
                        endTime: null,
            ...
            getNumber(){
                ...
                this.$http.get("/api/getpie",{
                    params:{
                        ...
                        aggField:"SrcIP",
                        CombQuerysNot:{"threatType":["外部"]},
                        CombQuery:{'logtype':['LOG_FW_FILTER','LOG_LOCALPORTSCAN'],"Srctype":["服务器"]},
                        // 'EventType':['finger服务攻击','安全扫描','目录扫描攻击','sql注入攻击','爬虫攻击','web扫描']
                        begTime: this.bTime,
                        endTime: this.eTime,
                        size:10000
